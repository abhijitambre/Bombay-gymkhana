...
<body>
          ...
          <form id="redirectForm" method="post" action="request.php">
            <div class="row">
              ...
              <div class="form-group input1_inner" style="display: none;">
                ...
                <input class="form-control" id="orderId" name="orderId" value="" placeholder="Enter Order ID here (Ex. order00001)" />
              </div>
              <div class="col-md-6">
              ...
              <div class="col-md-6">
                <div class="form-group input1_inner" style="display:none;">
                  ...
                  <input class="form-control" name="returnUrl" value="https://bombaygymkhana.com/response.php" />
                </div>
              </div>
              <div class="col-md-6">
                <div class="form-group input1_inner" style="display:none;">
                  <label>Notify URL:</label><br>
                  <input class="form-control" name="notifyUrl" value="https://bombaygymkhana.com/response.php" />
                </div>
              </div>
              <div class="col-md-12">
  ...
  <script>
    $(document).ready(function() {
      ...
      const unique = dateString + rand + "--1" + memberid;
      document.getElementById("orderId").value = unique;
