                                ...
                                <div class="x_content">
                                    ...
                                    <table id="datatable-responsive" class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
                                        ...
                                        <tbody>
                                            ...
                                            ?>
                                                <tr>
                                                    <td><?php echo $proo['name_ach']; ?></td>
                                                    <td><?php echo $proo['description']; ?></td>
                                                    <td> <?php echo '<img src="data:image/jpeg;base64,' . base64_encode($proo['image']) . '"   style=" width: 100px;"/>' ?>
                                                    </td>
                                                    <td><?php echo $proo['Date']; ?></td>
                                                    <td><?php echo $proo['end_date']; ?></td>

                                                    <td><?php echo $proo['time']; ?></td>
                                                    <td><?php echo $proo['end_time']; ?></td>


                                                    <td>
                                                        <a href="formnotice.php?edit=<?php echo $proo['id']; ?>" class="edit_btn">Edit</a>
                                                    </td>
                                                    <td>
                                                        <a href="addach.php?del=<?php echo $proo['id']; ?>" class="del_btn">Delete</a>
                                                    </td>
