...
<body>
    ...
    <div class="banner-header section-padding valign bg-img bg-fixed" data-overlay-dark="4" data-background="images/banner-images/food-court.JPG">
        <div class="container">
            <div class="row">
                                ...
                                <div class="row">
                                                    ...
                                                    <ul class="list-unstyled page-list mb-30">
                                                        ...
                                                        <li>
                                                            ...
                                                            <div class="page-list-text">
                                                                <p>7:30 AM to 11:00 PM (last order 10.30 PM)</p>
                                                            </div>
                                                        </li>
                                                        <br>
                                                        <h4>INDIGO CAFÉ AT THE The Cafe</h4><br>
                                    ...
                                    <div class="col-md-5 ">
                                        <div class="restaurant-menu menu-menu tabs-icon col-md-10 offset-md-1 text-center">
                                            ...
                                            <div class=" owl-carousel owl-theme thecafe-menu">
                                                <div id="tab-1" class="active item">
                                                    <!-- <img src="img/rooms/1.jpg" alt=""> -->
                                                    <div class="box">

                                                        <a href="images/menu/thecafe/1.jpg" data-fancybox="gallery" data-caption="">
                                                            <div class="link-icon">
                                                                <img src="images/menu/thecafe/1.jpg" width="100%" />
                                                ...
                                                <div id="tab-2" class="item">
                                                    <div class="box">
                                                        ...
                                                        <a href="images/menu/thecafe/2.jpg" data-fancybox="gallery" data-caption="">
                                                            <div class="link-icon">
                                                                <img src="images/menu/thecafe/2.jpg" width="100%" />
                                                                <div class="box-content">
                                                                    <!-- <h3 class="title">Semi Aerial View</h3> -->
                                                                </div>
                                                                <ul class="icon">
                                                ...
                                                <div id="tab-3" class="item">
                                                    <div class="box">
                                                        ...
                                                        <a href="images/menu/thecafe/3.jpg" data-fancybox="gallery" data-caption="">
                                                            <div class="link-icon">
                                                                <img src="images/menu/thecafe/3.jpg" width="100%" />
                                                                <div class="box-content">
                                                                    <!-- <h3 class="title">Semi Aerial View</h3> -->
                                                                </div>
                                                                <ul class="icon">
