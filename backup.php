                                                        ...
                                                        <div class="profile-card__cnt js-profile-cnt">
                                                            <div class="profile-card-social">
                                                                <ul class="das-btn row">
                                                                        ...
                                                                        <button id="checkinButton" class="profile-card-social__item checkin-btn">
                                                                            <div class="icon-font checkin-icon">
                                                                                <div class="icon">
                                                                                    ...
                                                                                    <p class="checkintext" id="checkintext">Check In</p>
                                                                    ...
                                                                    <li class="col-md-3 col-4">
                                                                        <a href="/pdf/bng/may-2024.pdf" class="profile-card-social__item facebook">
                                                                            <div class="icon-font">
                                                                                <div class="icon">
    ...
    <script>
        document.addEventListener("DOMContentLoaded", function() {
            ...
            function showPosition(position) {
                ...
                var distanceToGym = getDistanceFromLatLonInKm(lat1, lon1, 18.938473, 72.830380);
                handleCheckInCheckOut(distanceToGym, memberName, memberCode);
            }

            function handleCheckInCheckOut(distance, memberName, memberCode) {
                var isCheckedIn = Cookies.get('checkedin') === "checkedin";

                if (distance <= 500) {
                    if (isCheckedIn) {
                        checkOut(memberName, memberCode);
                    } else {
                        checkIn(memberName, memberCode);
                    }
                } else {
                    Swal.fire(isCheckedIn ? "Check Out Failed" : "Check In Failed", "Get Near the Gym", "error");
                }
            }


            function checkIn(memberName, memberCode) {
                sendCheckInRequest(memberName, memberCode, "Check In");
                setCheckInCookie();
                Swal.fire("Checked In", "", "success");
                document.getElementById("checkintext").textContent = "Check Out";
            }

            function checkOut(memberName, memberCode) {
                sendCheckInRequest(memberName, memberCode, "Check Out");
                removeCheckInCookie();
                Swal.fire("Checked Out", "", "success");
                document.getElementById("checkintext").textContent = "Check In";
            }

            function sendCheckInRequest(memberName, memberCode, action) {
                var settings = {
            ...
            function removeCheckInCookie() {
                $.removeCookie('checkedin');
            }
