    ...
    <script>
        $(document).ready(function() {
            ...
            $('#submitotp').click(function(event) {
                ...
                var CookieValue4 = Cookies.get('otp');
                // The otp is stored in the otp2 variable
                var otp2 = CookieValue4;
                ...
                var clientid1 = CookieValue1;
                var CookieValue2 = Cookies.get('clientid2');
                var clientid2 = CookieValue2;
                var clientid4 = CookieValue2;
                ...
                if (otp === otp2) {
                    ...
                    if (count1 === 1) {
                        if (count === 0) {
                            var fullid = clientid1 + "-" + clientid2 + "      " + clientid3;
                        } else if (count === 1) {
                            var fullid = clientid1 + "-" + clientid2 + "     " + clientid3;
                        } else if (count === 2) {
                            var fullid = clientid1 + "-" + clientid2 + "    " + clientid3;
                    ...
                    $.ajax(settings).done(function(memcode) {
                        ...
                        if (memcode.StatusCode === 0 && memcode.Result.length > 0) {
                            ...
                            window.location.href = "/myprofile#user-profile";
                            var correct = "correct";
                        } else {
