...
<!-- Mirrored from duruthemes.com/demo/html/cappa/demo1/post.php by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 14 Jul 2022 10:36:46 GMT -->
<head>
    <meta charset="utf-8">
...
<body>
                ...
                <ul class="navbar-nav ml-auto">
                    ...
                    <li class="nav-item dropdown"> <span class="nav-link active"> News <i class="ti-angle-down"></i></span>
                        <ul class="dropdown-menu last">
                            ...
                            <li class="dropdown-item active"><a href="post.php">Single Post</a></li>
                        </ul>
                    </li>
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-12 text-left caption mt-90">
                    <h5><a href="news.php">News</a> / Post Page</h5>
                    <h1>Historic Restaurant</h1>
                    <div class="post">
                        <div class="author"> <img src="img/team/5.jpg" alt="" class="avatar"> <span>Emma Emily</span> </div>
    ...
    <section class="section-padding">
        <div class="container">
            <div class="row">
                <div class="col-md-8"> 
                    <img src="img/restaurant/2.jpg" class="mb-30" alt="">
                            ...
                            <div class="widget">
                                ...
                                <ul class="recent">
                                    ...
                                    <li>
                                        ...
                                        <a href="post3.php">Retro Lighting Design in The Hotels</a>
                                    </li>
                                </ul>
                            </div>
                        </div>
...
<!-- Mirrored from duruthemes.com/demo/html/cappa/demo1/post.php by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 14 Jul 2022 10:37:05 GMT -->
</html>