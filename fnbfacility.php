...
<body>
    ...
    <div class="banner-header section-padding valign bg-img bg-fixed" data-overlay-dark="4" data-background="img/slider/fnb.jpg" style="background-image: url('img/slider/fnb.jpg');">
        <div class="container">
            <div class="row">
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-12 text-center">
                    ...
                    <div class="section-title"><a href="libraryfacility.php"><span class="ti-arrow-left"></span> </a><span>F&B</span><a href="sportsfacility.php"><span class="ti-arrow-right"></span> </a></div>
                </div>
            </div>
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="col-md-4">
                        ...
                        <div class="footer-column footer-contact">
                            ...
                            <ul class="footer-explore-list list-unstyled">
                                ...
                                <li class="md-none"><a href="/club.php#desktop-vmv">Vision</a></li>
                            <li class="md-block"><a href="/club.php#mobile-vmv">Vision</a></li>
                            </ul>
...
-->
    ...
    for (let i = 0; i < fnb.length; i++) {
        $(".cstm-price").append(`<div class="pricing-cardint col-md-4 sm-img-blk">
<div class="desc">
    <div class="name">${fnb[i].name}</div>
    <div class="amount"><span> ${fnb[i].desc}</span></div>
</div>
</div>`)
    }
    </script>
