...
<!-- Mirrored from duruthemes.com/demo/html/cappa/demo1/news2.php by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 14 Jul 2022 10:36:16 GMT -->
<head>
    <meta charset="utf-8">
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav ml-auto">
                    ...
                    <li class="nav-item dropdown"> <span class="nav-link active"> News <i class="ti-angle-down"></i></span>
                        <ul class="dropdown-menu last">
                            <li class="dropdown-item"><a href="news.php">News 1</a></li>
                            <li class="dropdown-item active"><a href="news2.php">News 2</a></li>
                ...
                <div class="col-md-8">
                    <div class="row">
                        <div class="col-md-12">
                            <div class="item">
                                <div class="post-img">
                                    <a href="post.php"> <img src="img/restaurant/2.jpg" alt=""> </a>
                                    <div class="date">
                                        <a href="post.php"> <span>Dec</span> <i>02</i> </a>
                                    </div>
                                </div>
                                <div class="post-cont"> 
                                   <a href="news.php"><span class="tag">Restaurant</span></a>
                                    ...
                                    <div class="butn-dark"> <a href="post.php"><span>Read More</span></a> </div>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-12">
                            <div class="item">
                                <div class="post-img">
                                    <a href="post.php"> <img src="img/spa/3.jpg" alt=""> </a>
                                    <div class="date">
                                        <a href="post.php"> <span>Dec</span> <i>04</i> </a>
                                    </div>
                                </div>
                                <div class="post-cont"> <a href="news.php"><span class="tag">Spa Center</span></a>
                        ...
                        <div class="col-md-12">
                            <div class="item">
                                <div class="post-img">
                                    <a href="post.php"> <img src="img/slider/7.jpg" alt=""> </a>
                                    <div class="date">
                                        <a href="post.php"> <span>Dec</span> <i>06</i> </a>
                                    </div>
                                </div>
                                <div class="post-cont">
                                   <a href="news.php"><span class="tag">Hotel Design</span></a>
                    ...
                    <div class="news2-sidebar row">
                            ...
                            <div class="widget">
                                ...
                                <ul class="recent">
                                    <li>
                                        ...
                                        <a href="post.php">Historic restaurant renovated</a>
                                    </li>
                                    <li>
                                        <div class="thum"> <img src="img/spa/3.jpg" alt=""> </div> 
                                        <a href="post.php">Benefits of Spa Treatments</a>
                                    </li>
                                    <li>
                                        <div class="thum"> <img src="img/slider/7.jpg" alt=""> </div> 
                                        <a href="post.php">Retro Lighting Design in The Hotels</a>
                                    </li>
                                </ul>
                            </div>
                        </div>
                        ...
                        <div class="col-md-12">
                            <div class="widget">
                                ...
                                <ul>
                                    <li><a href="news.php"><i class="ti-angle-right"></i>Restaurant</a></li>
                                    <li><a href="news.php"><i class="ti-angle-right"></i>Hotel Design</a></li>
                                    <li><a href="news.php"><i class="ti-angle-right"></i>Span Center</a></li>
                                </ul>
                            </div>
                        </div>
                        <div class="col-md-12">
...
<!-- Mirrored from duruthemes.com/demo/html/cappa/demo1/news2.php by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 14 Jul 2022 10:36:46 GMT -->
</html>