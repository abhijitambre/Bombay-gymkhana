...
<body>
    ...
    <div class="banner-header section-padding valign bg-img bg-fixed" data-overlay-dark="4" data-background="img/slider/sports.jpg" style="background-image: url('img/slider/sports.jpg');">
        <div class="container">
            <div class="row">
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-12 text-center">
                    ...
                    <div class="section-title"><a href="fnbfacility.php"><span class="ti-arrow-left"></span> </a><span>Sports </span><a href="preeningfacility.php"><span class="ti-arrow-right"></span> </a></div>
                </div>
            </div>
            <div class="row">
                <div class="col-md-12">
...
-->
    ...
    let sportsdetail = [
        {
            name: "Football",
            desc: "The Bombay Gymkhana grounds are used as a full sized grass turf football pitch during the football season. The pitch is floodlit for tournaments & regular practice.",
        },
        {
            name: "Cricket",
            desc: "Bombay Gymkhana Ltd., established in 1875, is one of the oldest and most prestigious Clubs in India with a rich sporting culture and tradition. It is said to be the birthplace of Indian Cricket by virtue of having staged Presidency, Triangular, and Quadrangular and Pentangular tournament during 1892 to 1933.",
        },
        {
            name:"Billiards & Snooker ",
            desc:"The Bombay Gymkhana Billiards & Snooker Room is a fully air-conditioned facility with 6 (six) majestic Billiard/Snooker tables.",
        },
        {
            name:"Bridge",
            desc:"The Bombay Gymkhana has a fully Air-conditioned Bridge Room, regular Pairs Bridge tournaments are conducted on first and third Saturdays and every Sunday of the month.",
        },
        {
            name:"Swimming",
            desc:"We have a beautiful Swimming Pool, which is 25 meters long, 10.95 meters wide, the deepness ranging from 1.20 meters to 3.6 meters, with diving boards of height 1 meter, 3 meters and 5 meters.",
        },
        {
            name:"Yoga",
            desc:"Yoga is an ancient science with complete answers to the healing process for human body, mind and soul, with fantastic benefits for not only physical problems but for hypertension, stress, acidity-the list is endless.",
        },
        {
            name:"Fitness Center",
            desc:"The Bombay Gymkhana has a fully Air-conditioned Gymnasium facility which is equipped with the latest gym equipment.",
        },
        {
            name:"Badminton",
            desc:"Bombay Gymkhana boasts of a spacious fully Air-conditioned Badminton Hall that houses three courts and a generous seating area. All three courts have layered teakwood flooring for enhanced player comfort, with a synthetic Hova court laid on the centre court to allow players to experience the surface employed in all international tournaments.",
        },
        {
            name:"Tennis",
            desc:"Bombay Gymkhana has six floodlit Tennis Courts. Being the first Club in the country to floodlight its Tennis courts, it has six synthetic all weather courts laid with Australian duco turf for a true playing surface to keep abreast with the latest technology and to keep in sync with the times.",
        },
        {
            name:"Squash",
            desc:"The Bombay Gymkhana Squash Courts are situated in a lovely heritage building at a walking distance of three minutes from the main Gymkhana building. All of these courts are air-conditioned glass back courts.",
        },
        {
            name:"Rugby",
            desc:"The Bombay Gymkhana is one of the homes of Rugby in India, with the sport having been played here since the early 1900s! We have a vibrant Rugby culture and strong history and association with the game, with our senior team participating in the elite division of National Rugby and a large proportion of senior team having represented India since India’s international debut in 1998.",
        },

    ]
    
    for (let i = 0; i < sportsdetail.length; i++) {
        $(".cstm-price").append(`<div class="pricing-cardint col-md-4 sm-img-blk">
<div class="desc">
    <div class="name">${sportsdetail[i].name}</div>
    <div class="amount"><span> ${sportsdetail[i].desc}</span></div>
</div>
</div>`)
    }
    </script>
