...
<!-- Mirrored from duruthemes.com/demo/html/cappa/demo1/index4.php by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 14 Jul 2022 10:34:32 GMT -->
<head>
    <meta charset="utf-8">
                ...
                <ul class="navbar-nav ml-auto">
                    <li class="nav-item dropdown"> <span class="nav-link active"> Home <i class="ti-angle-down"></i></span>
                        <ul class="dropdown-menu last">
                            ...
                            <li class="dropdown-item active"><a href="index4.php">Home Layout 4</a></li>
    ...
    <div class="booking-wrapper">
            <div class="container">
                <div class="booking-inner clearfix">
                    <form action="http://duruthemes.com/demo/html/cappa/demo1/rooms.php" class="form1 clearfix">
                        <div class="col1 c1">
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="owl-carousel owl-theme">
                    <div class="item">
                        <div class="position-re o-hidden"> <img src="img/rooms/1.jpg" alt=""> </div> <span class="category"><a href="rooms2.php">Book</a></span>
                        <div class="con">
                    ...
                    <div class="item">
                        <div class="position-re o-hidden"> <img src="img/rooms/2.jpg" alt=""> </div> <span class="category"><a href="rooms2.php">Book</a></span>
                        <div class="con">
                            <h6><a href="room-details.php">200$ / Night</a></h6>
                    ...
                    <div class="item">
                        <div class="position-re o-hidden"> <img src="img/rooms/3.jpg" alt=""> </div> <span class="category"><a href="rooms2.php">Book</a></span>
                        <div class="con">
                            <h6><a href="room-details.php">250$ / Night</a></h6>
                    ...
                    <div class="item">
                        <div class="position-re o-hidden"> <img src="img/rooms/6.jpg" alt=""> </div> <span class="category"><a href="rooms2.php">Book</a></span>
                        <div class="con">
                            <h6><a href="room-details.php">300$ / Night</a></h6>
                    ...
                    <div class="item">
                        <div class="position-re o-hidden"> <img src="img/rooms/8.jpg" alt=""> </div> <span class="category"><a href="rooms2.php">Book</a></span>
                        <div class="con">
                            <h6><a href="room-details.php">350$ / Night</a></h6>
                    ...
                    <div class="item">
                        <div class="position-re o-hidden"> <img src="img/rooms/9.jpg" alt=""> </div> <span class="category"><a href="rooms2.php">Book</a></span>
                        <div class="con">
                            <h6><a href="room-details.php">400$ / Night</a></h6>
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-6 p-0 animate-box" data-animate-effect="fadeInLeft">
                    <div class="img left">
                        <a href="restaurant.php"><img src="img/restaurant/1.jpg" alt=""></a>
                    </div>
                </div>
                <div class="col-md-6 p-0 bg-cream valign animate-box" data-animate-effect="fadeInRight">
                    <div class="content">
                        <div class="cont text-left">
                            ...
                            <div class="butn-dark"> <a href="restaurant.php"><span>Learn More</span></a> </div>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="col-md-6 bg-cream p-0 order2 valign animate-box" data-animate-effect="fadeInLeft">
                    <div class="content">
                        <div class="cont text-left">
                            ...
                            <div class="butn-dark"> <a href="spa-wellness.php"><span>Learn More</span></a> </div>
                        </div>
                    </div>
                </div>
                <div class="col-md-6 p-0 order1 animate-box" data-animate-effect="fadeInRight">
                    <div class="img">
                        <a href="spa-wellness.php"><img src="img/spa/3.jpg" alt=""></a>
                    </div>
                </div>
            </div>
            <div class="row">
                <div class="col-md-6 p-0 animate-box" data-animate-effect="fadeInLeft">
                    <div class="img left">
                        <a href="spa-wellness.php"><img src="img/spa/2.jpg" alt=""></a>
                    </div>
                </div>
                <div class="col-md-6 p-0 bg-cream valign animate-box" data-animate-effect="fadeInRight">
                    <div class="content">
            ...
            <div class="row">
                ...
                <div class="col-md-6 p-0 order1 animate-box" data-animate-effect="fadeInRight">
                    <div class="img">
                        <a href="spa-wellness.php"><img src="img/spa/1.jpg" alt=""></a>
                    </div>
                </div>
            </div>
        </div>
                    ...
                    <div class="owl-carousel owl-theme">
                        <div class="item">
                            <div class="position-re o-hidden"> <img src="img/news/1.jpg" alt="">
                                <div class="date">
                                    <a href="post.php"> <span>Dec</span> <i>02</i> </a>
                                </div>
                            </div>
                            <div class="con"> <span class="category">
                                    <a href="news.php">Restaurant</a>
                                </span>
                                <h5><a href="post.php">Historic restaurant renovated</a></h5>
                            </div>
                        </div>
                        <div class="item">
                            <div class="position-re o-hidden"> <img src="img/news/2.jpg" alt="">
                                <div class="date">
                                    <a href="post.php"> <span>Dec</span> <i>04</i> </a>
                                </div>
                            </div>
                            <div class="con"> <span class="category">
                                    <a href="news.php">Spa</a>
                                </span>
                                <h5><a href="post.php">Benefits of Spa Treatments</a></h5>
                            </div>
                        </div>
                        <div class="item">
                            <div class="position-re o-hidden"> <img src="img/news/3.jpg" alt="">
                                <div class="date">
                                    <a href="post.php"> <span>Dec</span> <i>06</i> </a>
                                </div>
                            </div>
                            <div class="con"> <span class="category">
                                    <a href="news.php">Bathrooms</a>
                                </span>
                                <h5><a href="post.php">Hotel Bathroom Collections</a></h5>
                            </div>
                        </div>
                        <div class="item">
                            <div class="position-re o-hidden"> <img src="img/news/4.jpg" alt="">
                                <div class="date">
                                    <a href="post.php"> <span>Dec</span> <i>08</i> </a>
                                </div>
                            </div>
                            <div class="con"> 
                                <span class="category">
                                    <a href="news.php">Health</a>
                                </span>
                                <h5><a href="post.php">Weight Loss with Fitness Health Club</a></h5>
                            </div>
                        </div>
                        ...
                        <div class="item">
                            ...
                            <div class="con"> <span class="category">
                                    <a href="news.php">Design</a>
                                </span>
                                <h5><a href="post.php">Retro Lighting Design in The Hotels</a></h5>
                            </div>
                        </div>
                        <div class="item">
                            ...
                            <div class="con"> <span class="category">
                                ...
                                <h5><a href="post.php">Benefits of Swimming for Your Health</a></h5>
                            </div>
                        </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-5 offset-md-2">
                        <div class="booking-box">
                            ...
                            <div class="booking-inner clearfix">
                                <form action="http://duruthemes.com/demo/html/cappa/demo1/rooms2.php" class="form1 clearfix">
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="input1_wrapper">
                                                <label>Check in</label>
