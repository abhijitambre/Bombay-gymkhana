                        ...
                        <form id="iciciform" method="post" action="">
                            <div class="row">
                                ...
                                <div class="col-md-6 form-group input1_inner" style="display: none;">
                                    ...
                                    <input class="form-control" type="url" name="returnUrl" id="returnUrl" value="https://www.bombaygymkhana.com/paymentsdetails" required />
                                </div>
                                <div class="col-md-12">
    ...
    <script>
        $(document).ready(function() {
            ...
            if (amountpay !== undefined) {
                document.getElementById("orderamount").value = amountpay;
            } else if (balancedue !== undefined) {
                document.getElementById("orderamount").value = balancedue;
            }
        });
    </script>
</body>
