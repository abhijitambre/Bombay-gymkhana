...
<body>
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav ml-auto">
                    ...
                    <div class="butn-dark intersterd desktop-login md-none"> <a href="javascript:void(0);" To><span>Member Login</span></a></div>
                    <div class="butn-dark intersterd  mobile-login md-block"> <a href="/login" To><span>Member Login</span></a></div>
                </ul>
            </div>
        </div>
    </nav>
    ...
    <header class="header slider-fade" id="header">
        <div class="owl-carousel owl-theme">
            <div class="text-center item bg-img" data-overlay-dark="1" id="">
...
//     if (isAndroid) {
//         // Check if the user agent string exactly matches "Android 10"
//         var isAndroid10 = /\bandroid\s10\b/.test(userAgent);

//         if (isAndroid10) {
//             $('.desktop-login').addClass('android-10-block');
//             $('.mobile-login').addClass('android-10-none');
//             alert("android-10");
//             console.log('User is using Android 10');
//             // Your code here
//         } else {
//             console.log('User is using Android but not Android 10');
//             // Your code here for other Android versions
//         }
//     } else {
//         console.log('User is not using Android');
//         // Your code here for non-Android devices
//     }
// });
