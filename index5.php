...
<!-- Mirrored from duruthemes.com/demo/html/cappa/demo1/index5.php by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 14 Jul 2022 10:34:32 GMT -->
<head>
    <meta charset="utf-8">
                ...
                <ul class="navbar-nav ml-auto">
                    <li class="nav-item dropdown"> <span class="nav-link active"> Home <i class="ti-angle-down"></i></span>
                        <ul class="dropdown-menu last">
                            ...
                            <li class="dropdown-item active"><a href="index5.php">Home Layout 5</a></li>
                        </ul>
                    </li>
    ...
    <section class="rooms1 section-padding bg-cream" data-scroll-index="1">
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <div class="item">
                        <div class="position-re o-hidden"> <img src="img/rooms/4.jpg" alt=""> </div> <span class="category"><a href="rooms2.php">Book</a></span>
                        <div class="con">
                ...
                <div class="col-md-6">
                    <div class="item">
                        <div class="position-re o-hidden"> <img src="img/rooms/7.jpg" alt=""> </div> <span class="category"><a href="rooms2.php">Book</a></span>
                        <div class="con">
                            <h6><a href="room-details.php">150$ / Night</a></h6>
