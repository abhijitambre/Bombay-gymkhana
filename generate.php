...
<body>
    ...
    <section class="about section-padding bg-black" id="about">
        ...
        <div class="container">
            <div class="row ">
                <div class="col-md-6" id="id-form" style="margin:auto">
                    <div class="booking-inner clearfix">
                        <form action="javascript:void(0);" class="form1 clearfix">
                            <div class="row">
                                <div class="col-md-4">
                                ...
                                <div class="col-md-4">
                                    <div class="input1_wrapper">
                                        <div class="input1_inner">
                                            <input type="text" name="clientid2reset" class="form-control input " placeholder="e.g 001">
                                ...
                                <div class="col-md-12">
                                    ...
                                    <button type="submit" id="genpassword" name="genpassword" class="btn-form1-submit mt-15">Generate</button>
                                    <p class="gentxt">
    ...
    <script>
        $('#genpassword').click(function() {
            ...
            var clientid2 = jQuery('input[name="clientid2reset"]');
            ...
            document.cookie = "clientid1=" + clientid1;
            document.cookie = "clientid2=" + clientid4;
            document.cookie = "clientid3=" + clientid3;
            ...
            $.ajax(settings).done(function(response) {
                if (response.StatusCode === 0 && response.StatusDescription === "Success") {
                    ...
                    var cookieValue = encodeURIComponent(JSON.stringify(response));
                    document.cookie = "memdetails1=" + cookieValue + ';expires=' + expirationTime.toUTCString() + ';path=/'; // set the cookie with the JSON string
                    window.location.href = "/verification.php";
                } else {
                    swal("Password Generation Failed", "", "error");
                }
            });
