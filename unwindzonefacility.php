        ...
        <div class="container">
            <div class="row">
                <div class="col-md-12 text-center">
                    ...
                    <div class="section-title"><a href="preeningfacility.php"><span class="ti-arrow-left"></span> </a><span>Unwind Zone </span><a href="libraryfacility.php"><span class="ti-arrow-right"></span> </a></div>
                </div>
            </div>
            <div class="row">
                <div class="col-md-12">
    ...
    let zone = [
        {
            ...
            desc: "Bombay Gym has an open and safe haven for children to play and enjoy themselves while families and friends enjoy the Club facilities.",
        },
        {
            name: "Siesta Room",
            desc: "Located on the first floor adjacent to the library is the Gentlemen’s Siesta Room which is a cozy room with reclining chairs for members to relax.",
        },
