...
<body>
                                                        ...
                                                        <div class="profile-card__cnt js-profile-cnt">
                                                            <div class="profile-card-social">
                                                                <ul class="das-btn row">
                                                                    ...
                                                                    <li class="col-md-3 col-4">
                                                                        <a href="/payments.php" class="profile-card-social__item facebook">
                                                                            <div class="icon-font">
                                                                                <div class="icon">
                                                                    ...
                                                                    <li class="col-md-3 col-4">
                                                                        <a href="/pdf/bng/July-2024.pdf" class="profile-card-social__item facebook">
                                                                            <div class="icon-font">
                                                                                <div class="icon">
    ...
    <script>
        document.addEventListener("DOMContentLoaded", function() {
            ...
            if (CookieValue) {
                const obj = JSON.parse(CookieValue);
                memberName = obj.Result[0].MemberName;
                memberCode = obj.Result[0].MemberCode;
            }

            var isCheckedIn = Cookies.get('checkedin') === "checkedin";
            document.getElementById("checkintext").textContent = isCheckedIn ? "Check Out" : "Check In";

            checkinButton.addEventListener("click", handleCheckInCheckOut);
            checkinButton.addEventListener("touchend", handleCheckInCheckOut);
                ...
                navigator.geolocation.getCurrentPosition(function(position) {
                        ...
                        if (Cookies.get('checkedin') === "checkedin") {
                            ...
                            if (distanceToGym <= 2500) {
                                ...
                                document.cookie = "checkedin=checkedin; expires=" + currentDate.toUTCString();
                                Swal.fire("Checked In", "", "success");
                                document.getElementById("checkintext").textContent = "Check Out";
                            }
                            else {
                                Swal.fire("Check In Failed", "Get Near the Gym", "error");
                            }
                        }
                    },
                    function(error) {
