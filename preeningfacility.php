...
<body>
    ...
    <div class="banner-header section-padding valign bg-img bg-fixed" data-overlay-dark="4" data-background="img/slider/verndha.jpg" style="background-image: url('img/slider/verndha.jpg');">
        <div class="container">
            <div class="row">
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-12 text-center">
                    ...
                    <div class="section-title"><a href="sportsfacility.php"><span class="ti-arrow-left"></span> </a><span>Preening Point </span><a href="unwindzonefacility.php"><span class="ti-arrow-right"></span> </a></div>
                </div>
            </div>
            <div class="row">
                <div class="col-md-12">
...
-->
    ...
    let zone = [
        {
            name: "Steam Room ",
            desc: "The Steam Room Facility is available in the Ladies Dressing Room and Gents Dressing Room.",
        },
        {
            name: "Manicure and Pedicure",
            desc: "The Pedicure & Manicure Room is located on the walkway to the Swimming Pool.",
        },
        {
            name: "Massage Facility",
            desc: "The Pedicure & Manicure Room is located on the walkway to the Swimming Pool.",
        },
        {
            name: "Hairdressing Salon",
            desc: "The Hair Dressing Saloon is situated inside the Gents Dressing Room, which provides wide variety of services like hair dressing, shaving, hair dye with shampoo, face and head massage to its Member.",
        },
...
<div class="desc">
    <div class="name">${zone[i].name}</div>
    <div class="amount"><span> ${zone[i].desc}</span></div>
</div>
</div>`)
    }
    </script>
